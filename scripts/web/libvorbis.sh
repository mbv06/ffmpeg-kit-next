...
# WEB (WASM) LIBVORBIS BUILD
# Autotools build via Emscripten. Portable C; depends on libogg (built earlier in
# the loop), located via explicit --with-ogg paths with pkg-config disabled for
# determinism (same as the Android build). Static + PIC.
