...
# WEB (WASM) OPENSSL BUILD
# OpenSSL does not use autotools; its generic 32-bit Linux target works with
# Emscripten when assembly, dynamic loading, apps, tests, async, and zlib support
# are disabled. Static archives are linked into FFmpeg side modules.
