...
# WEB (WASM) LIBSNDFILE BUILD
# Autotools build via Emscripten. Optional platform/external backends are
# disabled so the static library stays self-contained for wasm side-module links.
# Static + PIC.
