...
# WEB (WASM) SDL BUILD
# Autotools build via Emscripten. Native desktop/mobile backends and hardware
# input paths are disabled; the Emscripten target keeps SDL usable for FFmpeg's
# configure checks without pulling unavailable OS frameworks. Static + PIC.
