...
# WEB (WASM) GNUTLS BUILD
# Autotools build via Emscripten. Uses the separately built nettle/hogweed/gmp
# libraries and bundled libtasn1/unistring. Optional zlib/brotli/idn/p11-kit
# integrations are disabled so FFmpeg side-module links do not pull system libs.
...
# UPDATE BUILD FLAGS AND DEPENDENCY LOCATORS
