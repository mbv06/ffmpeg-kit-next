...
# WEB (WASM) LIBSAMPLERATE BUILD
# Autotools build via Emscripten. ALSA and FFTW integrations are disabled, and
# examples/tests are removed from the generated Makefile like the native builds.
# Static + PIC.
