...
# WEB (WASM) NETTLE BUILD
# Autotools build via Emscripten. Depends on gmp. Assembly and OpenSSL glue are
# disabled so the wasm build stays portable and avoids native crypto paths.
...
# UPDATE CONFIG FILES TO RECOGNIZE wasm32-unknown-emscripten
